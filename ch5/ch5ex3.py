...
def error_check(input_var): # not really doing what I want here... May not get used
    while input_var <= 0:
        print("ERROR: Please enter a positve non-zero number.\n")
        if input_var == budget:
            input_var = float(input("Please enter the total amount of your budget for the month.\n"))
        elif input_var == running_expense:
            input_var = float(input("Please enter your first expense.\n"))
        else:
            input_var = float(input("Please enter an acceptable value.\n"))
#call main function
main()
